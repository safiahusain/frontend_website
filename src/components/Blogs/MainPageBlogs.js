...
export default function MainPageBlogs({ className }) {
  const dispatch = useDispatch();
  const Blogs_list = useSelector((state) => state.Blogs.Blogs);
            ...
            <h4 className="text-[32px] mb-10 font-[700] mt-6 text-qblack">
              ...
              <Link href="/blogs" passHref>
                <a
                  ...
                  className="text-[16px] font-[400] ml-4 underline text-qblack"
                >
                  View All
                </a>
              </Link>
            ...
            <div className="main-wrapper w-full h-full">
              ...
              <div className="hero-slider-wrapper h-full mb-20 w-full relative">
                <SimpleSlider settings={settings} selector={sliderRef}>
                  {blogdata.map((datas, index) => (
                    <div key={index}>
                      <div style={{ margin: "0px 8px" }}>
                        <div
                          className={`blog-card-wrapper w-full group border-2 border-[#bda556] bg-[#bda556] rounded ${
                            className || ""
                          }`}
                        >
                          ...
                          <div className="p-[24px]">
                            <div className="short-data flex space-x-9 items-center mb-3">
                              <div className="flex space-x-1.5 items-center">
                                ...
                                <span className="text-base text-qgray capitalize">
                              ...
                              <div className="flex space-x-1.5 items-center">
                                ...
                                <span className="text-base text-qgray">
                            ...
                            <div className="details">
                              ...
                              >
                                <a rel="noopener noreferrer">
                                  <h1 className="text-[24px] text-qblack leading-[30px] group-hover:text-qpurple font-semibold line-clamp-2 mb-1 capitalizen cursor-pointer">
                                    {datas.title}
                                  </h1>
                                </a>
                              </Link>
                              <div className="w-full h-[1px] bg-qpurplelow/10 mt-4"></div>
                              ...
                              >
                                <a>
                                  <div className="flex items-center space-x-2 mt-5 text-qgray group-hover:text-qpurple">
