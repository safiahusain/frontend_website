                        ...
                        >
                          <div className="flex items-start gap-4 pb-10">
                            ...
                            <div>
                                ...
                                <div className="flex space-x-1">
                                  ...
                                  {parseInt(seller.averageRating) < 5 && (
                                    <>
                                      {Array.from(
                                        Array(
                                          5 - parseInt(seller.averageRating)
                                        ),
                                        () => (
                                          <span
                                            key={
                              ...
                              <p className="flex items-center gap-2 text-[14px] font-400 text-qblack mb-3">
                                <span>
                                  <svg
                                    width="14"
                                    height="19"
                              ...
                              <a
                                ...
                                className="uppercase font-500 text-qblack text-[14px] mb-3 flex items-center gap-2"
                              >
                                <span>
                                  <svg
                                    width="15"
                              ...
                              <a
                                ...
                                className="font-500 text-qblack text-[14px] flex items-center gap-2"
                              >
                                <span>
                                  <svg
                                    width="16"
                              ...
                              <br />
                              <h2 className="text-2xl font-700 text-qblack mt-1 mb-2">
                                Opening Times:
                              </h2>
                              <p className="block text-[14px] font-400 text-qblack mb-2">
                                {seller.open_at} to{seller.closed_at}
                              </p>
                            </div>
                          </div>
                        </div>
                            ...
                            >
                              <a rel="noopener noreferrer">
                                <div className="w-[116px] h-[40px] cursor-pointer ">
                                  <div className="transition-common bg-qpurple hover:bg-qpurplelow/10 hover:text-qpurple border border-transparent hover:border-qpurple text-white w-full h-full flex justify-center rounded">
